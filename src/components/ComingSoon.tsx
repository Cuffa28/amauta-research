  ...
  return (
    <div className="bg-surface-base flex-1">
      <div className="max-w-3xl mx-auto px-6 py-20">
        <div className="bg-surface-raised rounded-lg border border-brand-border p-10 text-center">
          ...
          <div className="mt-8 flex flex-wrap gap-3 justify-center">
            ...
            <Link
              href="/"
              className="inline-flex items-center justify-center rounded-md border border-brand-border text-text-secondary font-medium px-5 py-2 text-sm hover:bg-surface-overlay transition-colors"
            >
              Volver al inicio
            </Link>
          </div>
